...
describe('PaymmentSummary Component',()=>{
    ...
    beforeEach(()=>{
    loadCart = vi.fn();
   paymentsummary ={"totalItems":3,"productCostCents":2397,"shippingCostCents":0,"totalCostBeforeTaxCents":2397,"taxCents":240,"totalCostCents":2637}
})
    it('search For correct Dollar amount',async()=>{
        ...
        const payment1 = within(paymentSummaryrow[4]).getByTestId('correct-dollar-amount');
